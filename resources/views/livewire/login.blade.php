            ...
            <div class="flex items-center justify-center w-full px-6 py-8 lg:h-full lg:w-1/2">
                <div class="px-2 md:px-24 w-full h-full">
                    <div class="flex flex-col items-center justify-center">
                        ...
                        <h1 class="mb-4 text-xl font-semibold text-gray-500 dark:text-gray-200 py-8">Login into your account</h1>
                    ...
                    <form wire:submit.prevent="login" >
                        ...
                        <div class="block mt-2">
                            ...
                            <div class="block mb-4 border border-gray-200 rounded-lg">
                                <input type="password" name="password" id="password" class="block w-full px-4 py-3 border-2 border-transparent rounded-lg focus:border-blue-500 focus:outline-none @error('password') border-red-700 @enderror" placeholder="********" wire:model.defer="password">
                            </div>
                        ...
                        <div class="flex mt-6 text-sm">
                            <label class="flex items-center dark:text-gray-400">
                                <input type="checkbox" class="text-indigo-600 form-checkbox focus:border-indigo-400 focus:outline-none focus:shadow-outline-indigo dark:focus:shadow-outline-gray"  wire:model.defer="remember_me"/>
                                <span class="ml-2">
                                    Remember me
                                </span>
                            </label>
                    ...
                    <div class="flex flex-col md:flex-row md:justify-between">
                        <a class="text-sm font-medium text-indigo-600 dark:text-indigo-400 hover:underline" href="#">Forgot your password?</a>
                        <a class="text-sm font-medium text-indigo-600 dark:text-indigo-400 hover:underline" href="{{ url('register') }}">Create account</a>
                    </div>
                </div>
            </div>

            <div class="w-full h-64 lg:w-1/2 bg-cover lg:absolute lg:bottom-0 lg:right-0 lg:top-0 lg:h-full" style="background-image: url('{{ asset('storage/bg-login.jpeg') }}')">
                <div class="w-full h-full bg-black bg-opacity-70">
                    <div class="flex items-center justify-center w-full h-full px-8">
                        <div class="">
                            <h2 class="mb-8 text-xl md:text-4xl font-bold text-gray-100 leading-loose tracking-wider">Building tomorrow leaders <br>today through skillful <br>educational plan</h2>
                        </div>
                    </div>
                </div>
            </div>
