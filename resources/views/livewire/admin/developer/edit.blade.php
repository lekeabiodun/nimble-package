                    ...
                    <div class="w-full max-w-2xl">
                        <form wire:submit.prevent="update">
                            ...
                            <label class="form-control">
                                ...
                                <select class="input input-bordered @error('developer.title') input-error @enderror" wire:model.defer="developer.title">
                                ...
                                <x-error-message model="developer.title" />
                            </label>

                            <label class="form-control">
                                <label class="label"> <span class="label-text">Name</span> </label> 
                                <input class="input input-bordered @error('developer.name') input-error @enderror" wire:model.defer="developer.name">
                                <x-error-message model="developer.name" />
                            </label>

                            <label class="form-control">
                                <label class="label"> <span class="label-text">Gender</span> </label> 
                                <select class="input input-bordered @error('developer.gender') input-error @enderror" wire:model.defer="developer.gender">
                                    <option selected hidden value="">Select</option> 
                                    <option value="female">Female</option>
                                    <option value="male">Male</option>
                                </select>
                                <x-error-message model="developer.gender" />
                            </label>

                            <label class="form-control">
                                <label class="label"> <span class="label-text">Phone number</span> </label> 
                                <input type="tel" class="input input-bordered @error('developer.phone_number') input-error @enderror" wire:model.defer="developer.phone_number">
                                <x-error-message model="developer.phone_number" />
                            </label>

                            <label class="form-control">
                                <label class="label"> <span class="label-text">Whatsapp number</span> </label> 
                                <input type="tel" class="input input-bordered @error('developer.whatsapp_number') input-error @enderror" wire:model.defer="developer.whatsapp_number">
                                <x-error-message model="developer.whatsapp_number" />
                            </label>
                            ...
                            <div class="form-control">
                                ...
                                <textarea class="textarea textarea-bordered h-24 @error('developer.address') input-error @enderror" wire:model.defer="developer.address"></textarea>
                                <x-error-message model="developer.address" />
                            </div>

                            <label class="form-control">
                                <label class="label"> <span class="label-text">Level</span> </label> 
                                <select class="input input-bordered @error('developer.level') input-error @enderror" wire:model.defer="developer.level">
                                    <option selected hidden value="">Select</option> 
                                ...
                                <x-error-message model="developer.level" />
                            </label>
                            ...
                            <label class="form-control">
                                ...
                                <input type="email" class="input input-bordered @error('developer.email') input-error @enderror" wire:model.defer="developer.email">
                                <x-error-message model="developer.email" />
                            </label>

                            <label class="form-control">
                                <label class="label"> <span class="label-text">Username</span> </label> 
                                <input class="input input-bordered @error('developer.username') input-error @enderror" wire:model.defer="developer.username">
                                <x-error-message model="developer.username" />
                            </label>
